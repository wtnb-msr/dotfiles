# Costum Theme Setting ( based 'essembeh')
#
...
PROMPT='%{$fg_bold[$ZSH_THEME_COLOR_USER]%}%n@%{$fg_bold[$ZSH_THEME_COLOR_HOST]%}%M%{$reset_color%}:%{$fg_bold[$ZSH_THEME_COLOR_PWD]%}%~%{$reset_color%}
%(!.#.$) '
RPS1='${return_code} $(git_prompt_info)%{$fg[cyan]%}%D{[%T]}%{$reset_color%}'
